...
module.exports = pool => {
    ...
    api.get('/:classname/:id', (req, classname, id) => {
        _(req, classname, (cls, data) => {
            ...
            if (!check_act(req.session, "read", cls.ACL, obj.ACL))
                err.API(119);
    ...
    api.put('/:classname/:id', (req, classname, id) => {
        _(req, classname, (cls, data) => {
            ...
            var obj = _get(cls, id, util.union(Object.keys(data), ["ACL"]));

            if (!check_act(req.session, "write", cls.ACL, obj.ACL))
                err.API(119);
