...
export declare function filter_ext(session: FibApp.FibAppSession, obj: FxOrmInstance.Instance): FxOrmInstance.Instance<Record<string, FxOrmInstance.FieldRuntimeType>, any>;
